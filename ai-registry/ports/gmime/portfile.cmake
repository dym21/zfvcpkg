...
set(iconv_detect_h
    "${CURRENT_HOST_INSTALLED_DIR}/share/${PORT}/iconv-detect-${VCPKG_CMAKE_SYSTEM_NAME}.h"
)
...
if(EXISTS "${iconv_detect_h}")
    file(COPY_FILE
        "${iconv_detect_h}"
        "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/iconv-detect.h"
    )
    if(NOT VCPKG_BUILD_TYPE)
        file(COPY_FILE
            "${iconv_detect_h}"
            "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/iconv-detect.h"
        )
    endif()
endif()
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    file(COPY
        "${SOURCE_PATH}/build/vs2017/unistd.h"
