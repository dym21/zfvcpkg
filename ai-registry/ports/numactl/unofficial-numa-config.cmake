if(NOT TARGET unofficial::numa::numa)
    ...
    get_filename_component(
        Z_VCPKG_NUMA_ROOT "${CMAKE_CURRENT_LIST_DIR}/../.." ABSOLUTE
    )

    find_library(
        Z_VCPKG_NUMA_LIBRARY_RELEASE
        NAMES numa
        PATHS "${Z_VCPKG_NUMA_ROOT}/lib"
        NO_DEFAULT_PATH
        REQUIRED
    )
    find_library(
        Z_VCPKG_NUMA_LIBRARY_DEBUG
        NAMES numa
        PATHS "${Z_VCPKG_NUMA_ROOT}/debug/lib"
        NO_DEFAULT_PATH
    )
